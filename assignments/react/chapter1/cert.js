...
le.check({ domains: [ 'rara.nu' ] }).then(function (results) {
  if (results) {
  ...
  le.register({
    ...
    domains: ['rara.nu']                                // CHANGE TO YOUR DOMAIN (list for SANS)
  , email: 'rickard@rickardnilsson.com'                                 // CHANGE TO YOUR EMAIL
